...
export const QUESTIONS = [
	...
	},
	{
		...
		options: [
			...
			{ id: 'night', emoji: '🌙', label: 'Ніч', image: './images/q5-night.webp?v=3' },
			{ id: 'both', emoji: '😄', label: 'Я нормально функціоную і там, і там', image: './images/q5-both.webp?v=2' },
	...
	},
	{
		...
		options: [
			...
			{ id: 'nature', emoji: '🌳', label: 'Природа' , image: './images/q6-nature.webp?v=2' },
			...
			{ id: 'trip', emoji: '🚗', label: 'Кудись поїхати' , image: './images/q6-trip.webp?v=2' },
	...
	},
	{
		...
		options: [
			...
			{ id: 'worship', emoji: '🙌', label: 'Worship', image: './images/q7-worship.webp?v=2' },
