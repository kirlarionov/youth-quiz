...
export const QUESTIONS = [
	{
		...
		options: [
			{ id: 'mountains', emoji: '🏔️', label: 'Гори' },
			{ id: 'sea', emoji: '🌊', label: 'Море' },
			{ id: 'forest', emoji: '🌲', label: 'Ліс' },
			{ id: 'city', emoji: '🏙️', label: 'Велике місто' },
			{ id: 'cottage', emoji: '🏡', label: 'Будиночок десь у тиші' },
			{ id: 'travel', emoji: '✈️', label: 'Подорож у нове місце' },
		],
	},
	{
		id: 'q2',
		...
		options: [
			...
			{ id: 'motorsport', emoji: '🏎️', label: 'Формула-1 / автоспорт' },
			{ id: 'swimming', emoji: '🏊', label: 'Плавання' },
			{ id: 'cycling', emoji: '🚴', label: 'Велосипед' },
			{ id: 'running', emoji: '🏃', label: 'Біг' },
			{ id: 'gym', emoji: '🏋️', label: 'Тренажерний зал' },
			{ id: 'workout', emoji: '🤸', label: 'Турніки / воркаут' },
			{ id: 'no_sport', emoji: '😌', label: 'Спорт — не моє' },
		],
	},
	{
		id: 'q3',
