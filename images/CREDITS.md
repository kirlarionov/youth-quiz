...
Всё с Wikimedia Commons, свободные лицензии. Файлы обрезаны до 4:3 и
пережаты в WebP. Лицензии CC BY и CC BY-SA требуют указания автора при
использовании на публичном сайте — эта таблица его и обеспечивает.

## Вопрос 1 — «Який відпочинок тобі найближчий?»

| Файл | Вариант | Оригинал | Автор | Лицензия |
|---|---|---|---|---|
| `q1-mountains.webp` | [Mountains in snow, Chola Valley, Nepal, Himalayas](https://commons.wikimedia.org/wiki/File:Mountains_in_snow,_Mountain_lake,_Chola_Valley,_Nepal,_Himalayas.jpg) | Vyacheslav Argenberg | CC BY 4.0 |
| `q1-sea.webp` | [Baltic Sea view from Schmiedeberg hill in Rerik](https://commons.wikimedia.org/wiki/File:Baltic_Sea_view_from_Schmiedeberg_hill_in_Rerik,_2025-06-23.jpg) | Radomianin | CC BY-SA 4.0 |
| `q1-forest.webp` | [Forest path surrounded by green trees](https://commons.wikimedia.org/wiki/File:Forest_path_surrounded_by_green_trees.jpg) | Zed Can77 | CC0 |
| `q1-city.webp` | [Evening City Skyline (geograph 7759079)](https://commons.wikimedia.org/wiki/File:Evening_City_Skyline_-_geograph.org.uk_-_7759079.jpg) | Geograph, участник 43370 | CC BY-SA 2.0 |
| `q1-cottage.webp` | Будиночок десь у тиші | [Swedish Summer Dream - Flickr - northofsweden](https://commons.wikimedia.org/wiki/File:Swedish_Summer_Dream_-_Flickr_-_northofsweden.jpg) | northofsweden from Sweden | CC BY 2.0 |
| `q1-travel.webp` | Подорож у нове місце | [Commercial Airplane Wing (Starboard side)](https://commons.wikimedia.org/wiki/File:Commercial_Airplane_Wing_(Starboard_side).jpg) | Tmeers91 | CC BY-SA 4.0 |

## Вопрос 2 — «Який вид спорту або активності тобі подобається найбільше?»
...
| `q2-esports.webp` | Кіберспорт | [Iskandar Investment Esports Carnival 2019](https://commons.wikimedia.org/wiki/File:Iskandar_Investment_Esports_Carnival_2019.jpg) | Chongkian | CC BY-SA 4.0 |
| `q2-cycling.webp` | Велосипед | [Cyclist on North Jones Blvd](https://commons.wikimedia.org/wiki/File:Cyclist_on_North_Jones_Blvd.jpg) | Noah Wulf | CC BY-SA 3.0 |
| `q2-running.webp` | Біг | [Runners participate in a race in a busy street during a city event with spectators cheering on the sidelines](https://commons.wikimedia.org/wiki/File:Runners_participate_in_a_race_in_a_busy_street_during_a_city_event_with_spectators_cheering_on_the_sidelines.jpg) | Shixart1985 | CC BY 2.0 |
| `q2-gym.webp` | Тренажерний зал | [Young man lifting dumbbell weight for exercise in fitness gym](https://commons.wikimedia.org/wiki/File:Young_man_lifting_dumbbell_weight_for_exercise_in_fitness_gym.jpg) | Nenad Stojkovic | CC BY 2.0 |
